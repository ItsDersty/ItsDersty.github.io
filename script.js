...
function displayCard(index) {
    if (index >= 0 && index < flashcardsData.length) {
        ...
        if (cardData.picture) {
            backElement.innerHTML = `<img class="cardpicture" src='pics/${cardData.picture}.png'>`+backElement.innerHTML
        }
...
function checkAnswer(event) {
    ...
    if (currentQuestion.picture) {
        resultElement.innerHTML += `<br><img style='border-radius: 16px;' src='pics/${currentQuestion.picture}.png'>`
    }
}
